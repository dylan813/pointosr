...
class HumanDataset(Dataset):
    ...
    def _extract_per_point_features(self, points):
        ...
        # 5. mean_neighbor_dist (1 feature) - mean distance to neighbors
        ...
        # 6. radial_xy (1 feature) - radial distance in xy-plane from centroid
        radial_xy = np.linalg.norm(xyz[:, :2] - centroid[:2], axis=1, keepdims=True)
        
        # 7. angle_xy (1 feature) - angle in xy-plane
